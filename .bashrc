...
# To fix colors. also see .vim folder
if [[ $TERM = xterm ]]; then
    TERM=xterm-256color
fi

# For a nice prompt (must also place .git-prompt.sh in ~ (from github git)
...
# Auto-start ssh-agent and add keys, for Windows for Git
